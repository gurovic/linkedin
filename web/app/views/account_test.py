...
class AccountViewTestCase(TestCase):
    def setUp(self):
        self.client = Client()
        self.user1 = User.objects.create_user(username='testuser1', email='testuser1@example.com', password='testpassword', first_name="Name1", last_name="Surname1")
        self.user2 = User.objects.create_user(username='testuser2', email='testuser2@example.com', password='testpassword', first_name="Name2", last_name="Surname2")

        self.school1 = School.objects.create(name='Test School 1', country='RU')
        self.school2 = School.objects.create(name='Test School 2', country='US')
        ...
        self.university1 = University.objects.create(name='Test University 1', country='RU',majors_availible=['CS', 'MATH'])
        self.university2 = University.objects.create(name='Test University 2', country='US', majors_availible=['MATH'])

        self.student_school1 = StudentSchool.objects.create(student=self.user1, school=self.school1, start_year=2018, finish_year=2022, why_left='GR')
        self.student_school2 = StudentSchool.objects.create(student=self.user2, school=self.school2, start_year=2016, finish_year=2020, why_left='EX')
        self.university_student1 = UniversityStudent.objects.create(student=self.user1, university=self.university1, start_date='2020-09-01', end_date='2024-06-01', leave_reason='GRADUATION')
        self.university_student2 = UniversityStudent.objects.create(student=self.user2, university=self.university2, start_date='2018-09-01', end_date='2022-06-01', leave_reason='TRANSFER')
